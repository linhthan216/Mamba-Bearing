...
if args.dataset == 'CWRU':
    ...
    acc, f1, precision, recall = cal_metrics_5shot(test_dataloader_CWRU, net, device = args.device)

    print('Accuracy on CWRU test data:', acc)
    print('F1 score on CWRU test data:', f1)
    print('Precision on CWRU test data:', precision)
...
if args.dataset == 'HUST_bearing':
    ...
    acc, f1, precision, recall = cal_metrics_5shot(test_dataloader_HUST, net, device = args.device)

    print('Accuracy on HUST test data:', acc)
    print('F1 score on HUST test data:', f1)
    print('Precision on HUST test data:', precision)
